...
private final String LIB_FILE;

    public DVDLibFileDaoImpl() {
        LIB_FILE = "lib.txt";
    }
    
    public DVDLibFileDaoImpl(String libTextFile) {
        LIB_FILE = libTextFile;
        
    }
    /* changed the LIB File so that it exsists as a declaration(not a declaration
    and assignement.
    -use the Daoimp CONSTRUCTOR to assign the file name to the constant variable
    old---public static final String LIB_FILE = "lib.txt";*/
